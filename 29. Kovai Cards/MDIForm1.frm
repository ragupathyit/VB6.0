...
Begin VB.MDIForm MDIForm1 
   BackColor       =   &H00C0FFC0&
   Caption         =   "Kovai Cards Version 1.0"
   ClientHeight    =   6810
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   12555
   ...
   Begin MSComctlLib.StatusBar StatusBar1 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            Object.Width           =   14111
            MinWidth        =   14111
            Text            =   "Copyright @ Kovai Cards Version 1.0"
            TextSave        =   "Copyright @ Kovai Cards Version 1.0"
...
If Button.Caption = "Item Master" Then
    ...
    FrmItemMaster.Show
End If
If Button.Caption = "Customer Master" Then
    Call CloseForms
    FrmCustomerMaster.Show
End If
If Button.Caption = "Cash Sales" Then
    Call CloseForms
    FrmCashSales.Show
End If
If Button.Caption = "Credit Sales" Then
    Call CloseForms
    FrmCreditSales.Show
End If
