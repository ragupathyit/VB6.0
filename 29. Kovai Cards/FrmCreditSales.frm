...
Begin VB.Form FrmCreditSales 
   ...
   Begin Project1.Button BtnClose 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":0000
      PICN            =   "FrmCreditSales.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Project1.Button BtnSave 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":072E
      PICN            =   "FrmCreditSales.frx":074A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Project1.Button BtnDelete 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":0E5C
      PICN            =   "FrmCreditSales.frx":0E78
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Project1.Button BtnClear 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":158A
      PICN            =   "FrmCreditSales.frx":15A6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Project1.Button BtnPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":1CB8
      PICN            =   "FrmCreditSales.frx":1CD4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Project1.Button BtnNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":23E6
      PICN            =   "FrmCreditSales.frx":2402
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.ListBox lstItemName 
      ...
      EndProperty
      Height          =   4620
      ItemData        =   "FrmCreditSales.frx":2B14
      Left            =   120
      List            =   "FrmCreditSales.frx":2B16
      Style           =   1  'Checkbox
      TabIndex        =   3
      Top             =   1800
      Width           =   4568
   ...
   Begin Project1.Button BtnBill 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":2B18
      PICN            =   "FrmCreditSales.frx":2B34
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin MSComCtl2.DTPicker dtp_bdate 
      ...
      CurrentDate     =   42560
   End
   Begin Project1.Button BtnBalance 
      Height          =   495
      Left            =   120
      TabIndex        =   34
      ToolTipText     =   "BILL"
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmCreditSales.frx":2D59
      PICN            =   "FrmCreditSales.frx":2D75
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Image Image1 
      Height          =   360
      Left            =   120
      Picture         =   "FrmCreditSales.frx":4E57
      Top             =   240
      Width           =   360
   End
   ...
   End
End
Attribute VB_Name = "FrmCreditSales"
...
xlsheet.Cells(33, 9).Value = txtpayamt.Text
xlsheet.Range("I33").NumberFormat = "0.00"

xlsheet.Cells(34, 9).Value = txtbalamt.Text
...
If a = vbYes Then
    db.Execute "update tbl_creditsales set billcancel='Y' where billno='" & Trim(txtbillno.Text) & "'"
...
rs.Open "select * from tbl_creditsales where billno='" & bno & "'", db, adOpenDynamic, adLockOptimistic
If Not rs.EOF Then
    Call navigation
...
txtbalamt.Text = Format(rs.Fields("cbalance"), "0.00")
lblpayamt.Caption = Format(Round(Val(rs.Fields("totamt")) + Val(rs.Fields("stax"))), "0.00")
...
'-------------------Validation Ends Here-------------------------------
    If rs.State = 1 Then rs.Close
    rs.Open "select * from tbl_creditsales where billno='" & Trim(txtbillno.Text) & "'", db, adOpenDynamic, adLockOptimistic
    If Not rs.EOF Then
    ...
    If rs.State = 1 Then rs.Close
    rs.Open "select * from tbl_creditsales", db, adOpenDynamic, adLockOptimistic
    For i = 1 To MSGrid.Rows - 1
        rs.AddNew
        ...
        rs.Fields("cbalance") = Format(Val(Trim(txtbalamt.Text)), "0.00")
        rs.Update
    Next i
    rs.Close
    
    '====================Sales Balance====================
    If Trim(txtbalamt.Text) <> "0.00" Then
        If rs.State = 1 Then rs.Close
        rs.Open "select * from tbl_balance", db, adOpenDynamic, adLockOptimistic
        rs.AddNew
        rs.Fields("billno") = Trim(txtbillno.Text)
        rs.Fields("b_billno") = 1
        rs.Fields("bdate") = dtp_bdate.Value
        rs.Fields("cid") = IIf(cmbcid.Text = "", 0, Trim(cmbcid.Text))
        rs.Fields("cname") = Trim(cmbcname.Text)
        rs.Fields("mobno") = Trim(txtmobno.Text)
        rs.Fields("totamt") = Format(Val(lblpayamt.Caption), "0.00")
        ...
        rs.Fields("obalance") = "0.00"                                      'Old Balance
        rs.Update
        rs.Close
    End If
    '====================Sales Balance====================
    
    MsgBox "Credit Sales Saved Successfully...", vbInformation, "Kovai Cards"
...
Call generate_sno1("CCS")    'CCS - Credit Cash Sales or Credit Sales
...
If cmbcid.Text <> "" Then
    ...
    End If
    '====================================This line is for Round off the value===========================
    txtpayamt.Text = Format(Round(Val(amtp)), "0.00")
    lblpayamt.Caption = Format(Round(Val(amtp)), "0.00")
    txtbalamt.Text = Format(Val(lblpayamt.Caption) - Val(txtpayamt.Text), "0.00")
    '--------------Calculating the total quantity and amount
