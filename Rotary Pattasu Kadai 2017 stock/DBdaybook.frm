...
If Not rs.EOF Then
    MsgBox "Day book was already saved in this date", vbInformation, "Rotary Club of Mettupalayam"
Else
    rs.AddNew
...
Else
    MsgBox "No Records Found", vbInformation, "Rotary Club of Mettupalayam"
End If
rs.Close
