...
If Not txtid.Text = "" Then
    ...
    If s = vbYes Then
        ...
        Dim var1 As String
        Open App.Path & "\DBDayreport.txt" For Input As #1
        var1 = Input(LOF(1), #1)
        Close #1
...
If Not rs.EOF Then
    MsgBox "Day book was already saved in this date", vbInformation, "Sumathi Stores"
Else
    rs.AddNew
...
Else
    MsgBox "No Records Found", vbInformation, "Sumathi Stores"
End If
rs.Close
...
'lblsalesamt.BackColor = RGB(238, 6, 147)
...
lblsalesamt.BackColor = RGB(35, 29, 29)
