...
Begin VB.Form SalesFrm1 
   ...
   Begin VB.Label Label6 
      ...
      BackColor       =   &H00C00000&
      BackStyle       =   0  'Transparent
      Caption         =   "RETAIL SALES AND BILL DETAILS"
      BeginProperty Font 
         Name            =   "Arial Black"
         Size            =   18
         Charset         =   0
...
If KeyAscii = 112 Then  'p Key is for save and bill print
    Call CmdSave_Click
End If
End Sub
...
'If KeyCode = 115 Then   'F4 Key for Opening another SalesFrm2       Wholesale Sales
    'Me.WindowState = 1
        ...
        If MSGrid.Col = 0 Then      ' item code
            If MSGrid.TextMatrix(MSGrid.Row, 0) <> "" Then
                ...
                If Not rs.EOF Then
                    ...
                    MSGrid.TextMatrix(MSGrid.Row, 3) = Format(rs.Fields("retailrate"), "0.00")
...
'Label10.BackColor = RGB(238, 6, 147)
'Label11.BackColor = RGB(238, 6, 147)
'Label12.BackColor = RGB(238, 6, 147)
'lbllastbill.BackColor = RGB(238, 6, 147)
...
If Not rs1.EOF Then
    ...
    MSGrid.TextMatrix(MSGrid.Row, 3) = Format(rs1.Fields("retailrate"), "0.00")
