...
If Not rs.EOF Then
    MsgBox "Day book was already saved in this date", vbInformation, "Sri Annamalaiyar Pattasu Kadai"
Else
    rs.AddNew
...
Else
    MsgBox "No Records Found", vbInformation, "Sri Annamalaiyar Pattasu Kadai"
End If
rs.Close
