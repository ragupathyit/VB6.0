...
If Text1.Text = "" Then
    MsgBox "Enter the Supplier Name Properly...", vbInformation, "Sri Annamalaiyar Pattasu Kadai"
    Text1.SetFocus
ElseIf Text2.Text = "" Then
    MsgBox "Enter the Supplier Address Properly...", vbInformation, "Sri Annamalaiyar Pattasu Kadai"
    Text2.SetFocus
ElseIf Text3.Text = "" Then
    MsgBox "Enter the Phone/Cell No Properly...", vbInformation, "Sri Annamalaiyar Pattasu Kadai"
    Text3.SetFocus
Else
'-------------------Validation Ends Here-------------------------------
    ...
    If rs.EOF Then
        ...
        rs.Update
        MsgBox "Supplier Details Saved Successfully", vbInformation, "Sri Annamalaiyar Pattasu Kadai"
        rs.Close
    Else
        MsgBox "Enter The Another Name for Supplier", vbInformation, "Sri Annamalaiyar Pattasu Kadai"
    End If
    Call cmdclear_Click
End If
End Sub
